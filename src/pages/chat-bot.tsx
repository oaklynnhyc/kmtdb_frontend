...
const MOCK_REPLIES: Record<string, { summary: string; detail: string }> = {
  ...
  // },
  "可以依職位或單位搜尋嗎？": {
    summary: "可以。在職名錄檢索頁面的進階搜尋中，您可以選擇「職位」、「一級單位」、「二級單位」或「三級單位」作為搜尋欄位，輸入關鍵字即可查詢。也可組合多個條件進行精確搜尋。",
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "您好，歡迎使用中國國民黨職名錄數位加值系統研究助理。我可以協助您查詢職名錄資料庫、解答關於職名錄資料的疑問、提供歷史背景說明，以及協助您的研究工作。請問有什麼可以為您服務的嗎？",
      timestamp: new Date(),
    },
  ]);
